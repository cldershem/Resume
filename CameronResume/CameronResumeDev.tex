...
\showDev{\objective{%
%    To gain experience and knowledge while transitioning careers into application development by leveraging my enthusiasm for finding and building solutions along with my compulsion for efficiency and simplicity.}}
%    \begin{comment}
        To successfully transition careers into application development %
        by leveraging my enthusiasm for finding and building %
        solutions along with my compulsion for efficiency and simplicity; %
        obtaining an entry level position to gain experience and knowledge %
        -- seeking new challenges and stability.%
        }}%
%    \end{comment}
