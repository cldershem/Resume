...
\sectionHeader{PERSONAL \& PUBLIC PROJECTS}
    ...
    \begin{description}%
        \item[\textls{battleship}] Multiplayer game written in Python -- eventually to be rewritten as a webapp
        \item[\textls{homelessgaffer.com}] Simple CMS written in Python using Flask -- deployed using git-hooks
        \item[\textls{exercises}] More words that will probably wrap
        \item[\textls{something}] wordy words
        \item[\textls{something}] words
    \end{description}
