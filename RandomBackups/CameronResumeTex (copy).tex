...
\newcommand{\Location}{Indianapolis, IN}			%creates location var
...
%			\vspace{-.4em}
			...
			\hfill
			\emph{#4}\par}
%			\vspace{-.6em}}							%screws up hfill
%			}	
			
\setlength{\parskip}{5mm plus10mm minus10mm}
...
%\vspace{1em}
%\subsection*{Objective: \small \textsf \textbf To switch careers into awesomeness \\ donkey}
%{\textbf{Objective}:  To switch careers into awesomeness.  \\ donkey}
%\vspace{-.6em}
%\hrule
%\vspace{0.8em}
